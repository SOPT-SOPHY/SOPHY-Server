...
public class BooktalkController {
    ...
    public ApiResponseDto<BooktalkDetailResponseDto> getBooktalkDetail(@Parameter(example = "1") @PathVariable("booktalkId") Long booktalkId) {
    ...
    public ApiResponseDto<List<BooktalkResponseDto>> getPlacesByCity(@Parameter(description = "지역 이름", example = "UIJEONGBU_DONG") @Valid @PathVariable(name = "city") City city) {
    ...
    public ApiResponseDto postBooktalkParticipation(@Valid @RequestBody BooktalkParticipationRequestDto booktalkParticipationRequestDto, @Parameter(hidden = true) @AuthenticationPrincipal User user) {
