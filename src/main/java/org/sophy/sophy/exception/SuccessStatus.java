...
public enum SuccessStatus {
    ...
    GET_MY_PAGE_SUCCESS(HttpStatus.OK, "마이 페이지를 성공적으로 불러왔습니다."),
    GET_MY_INFO_SUCCESS(HttpStatus.OK, "내 정보를 성공적으로 불러왔습니다."),
    PATCH_MY_INFO_SUCCESS(HttpStatus.OK, "내 정보를 성공적으로 수정했습니다."),
